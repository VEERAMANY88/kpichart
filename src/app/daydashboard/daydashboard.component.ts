...
export class DaydashboardComponent implements OnInit {
    dayLevelResponse: any;

    constructor(private http: HttpClient) {}

    ngOnInit(): void {
        this.http.get<any>('http://127.0.0.1:5000/kpi').subscribe({
            next: (response:{day_level:any;}) => {
                this.dayLevelResponse = response.day_level;
